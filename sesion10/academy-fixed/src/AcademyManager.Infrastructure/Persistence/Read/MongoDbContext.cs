...
namespace AcademyManager.Infrastructure.Persistence.Read
{
    ...
    public sealed class MongoDbContext
    {
        ...
        // ── Constructor original (sin instrumentación OTel) ───────────────────
        ...
        // ── Constructor con MongoClientSettings (instrumentación OTel activa) ─
        //
        //  Usado por DependencyInjection.cs cuando se configura el
        //  DiagnosticsActivityEventSubscriber para OpenTelemetry.
        //  El ClusterConfigurator del settings ya lleva el subscriber registrado,
        //  así que cada operación del driver emitirá un Activity que OTel recoge
        //  como span con peer.service=mongodb-read en Jaeger/Zipkin.
        public MongoDbContext(IConfiguration configuration, MongoClientSettings settings)
        {
            RegisterConventions();
